<div class="bg-background-secondary grid w-full max-w-6xl mx-auto overflow-hidden text-color-base rounded-2xl shadow-2xl md:grid-cols-2" style="margin: 200px auto;">
        ...
        <div>
            <div class="mt-8 text-white">
                ...
                <p class="mt-3 text-white/80">
                    Create a new password for your account. Choose a strong password to keep your account secure and access all your billing features safely.
                </p>
            </div>
        </div>
