<div x-data class="fixed inset-0 z-[9999] pointer-events-none">
    <template x-for="(notification, index) in $store.notifications.notifications" :key="notification.id">
        <template x-teleport="body">
            <div x-show="notification.show" x-transition:enter="transition ease-out duration-300"
                ...
                class="fixed text-white px-4 py-2 rounded shadow-md mb-4 z-[2147483647] pointer-events-auto"
                :style="'top: ' + (100 + index * 60) + 'px;left: 50%; transform: translateX(-50%);'">
